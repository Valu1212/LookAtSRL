...
const Stack = () => {
  const course = {
    ...
    description: "Impulsa tu carrera con Java avanzado: optimiza proyectos y domina herramientas clave.",
    content: "Frameworks de Java, Técnicas Avanzadas, Optimización de Código",
    price: "$85.000",
    duration: "10 semanas",
